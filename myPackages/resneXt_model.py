...
################################################################################
def batch_norm(inputs, training, data_format):  # batch size批量大小将决定我们一次训练的样本数目
...
def _building_block_v2(inputs, filters, training, projection_shortcut, strides,
                       data_format):
  """A single block for ResNet v2, without a bottleneck.        # 瓶颈层(Bottleneck layer) 用 1×1 的卷积块（NiN）在昂贵的并行模块之前减少特征的数量
