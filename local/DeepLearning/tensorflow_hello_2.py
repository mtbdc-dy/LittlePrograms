...
with np.load('dataset/mnist/mnist.npz') as f:
...
generator = make_generator_model()      # model, return of make_generator_model()

noise = tf.random.normal([1, 100])
generated_image = generator(noise, training=False)

# plt.imshow(generated_image[0, :, :, 0], cmap='gray')  # 估计是tensorflow2.0的新特性
# plt.show()
